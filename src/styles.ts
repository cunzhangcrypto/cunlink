...
export const themes = {
  cunlink: {
    ...
    "--brand-surface-2": "#d4eadd",
    "--brand-accent": "#1a6b3c",
    "--brand-accent-soft": "#2d8a4e",
    "--brand-positive": "#1a6b3c",
    "--brand-info": "#3b82f6",
    ...
    /* semantic */
    "--color-canvas": "#fafcfb",
    "--color-surface": "#f0f7f3",
    "--color-surface-raised": "#ffffff",
    "--color-surface-interactive": "#e8f5ee",
    ...
    "--color-accent": "#1a6b3c",
    "--color-accent-hover": "#2d8a4e",
    "--color-accent-active": "#0f4d2a",
    ...
    "--color-focus-ring": "#1a6b3c",
    "--color-selection": "rgba(26, 107, 60, 0.12)",
...
[data-theme="cunlink"] .sidebar-oddbit a, [data-theme="light"] .sidebar-oddbit a, :root .sidebar-oddbit a { opacity: 1; }
[data-theme="cunlink"] .sidebar, [data-theme="light"] .sidebar { border-right: 1px solid var(--color-border); }
[data-theme="cunlink"] .bento-card, [data-theme="light"] .bento-card { box-shadow: 0 1px 3px var(--shadow-color); border: 1px solid var(--color-border); }
[data-theme="cunlink"] .bento-card:hover, [data-theme="light"] .bento-card:hover { background: var(--color-surface); box-shadow: 0 2px 8px var(--shadow-color); }
[data-theme="cunlink"] .hero-input, [data-theme="light"] .hero-input { background: var(--color-surface-raised); border-color: var(--color-border); }
[data-theme="cunlink"] .modal-inner, [data-theme="light"] .modal-inner { box-shadow: 0 8px 32px var(--shadow-color); }
[data-theme="cunlink"] .slug-chip, [data-theme="light"] .slug-chip { border-color: var(--color-border); }
[data-theme="cunlink"] .stat-row .bar, [data-theme="light"] .stat-row .bar { background: var(--color-surface-interactive); }
...
.theme-card[data-theme-preview="cunlink"] .theme-preview { background: #f0f7f3; border-color: #d1d5db; }
.theme-card[data-theme-preview="cunlink"] .theme-bar.one { background: #1a6b3c; }
.theme-card[data-theme-preview="cunlink"] .theme-bar.two { background: #9ca3af; }
.theme-card[data-theme-preview="cunlink"] .theme-bar.three { background: #d1d5db; }
