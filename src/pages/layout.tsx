...
export const Layout: FC<PropsWithChildren<LayoutProps>> = ({
  ...
  const currentTheme = theme || "cunlink";
      ...
      <body>
        <nav class="sidebar">
          <div class="sidebar-brand">
            <img src={brandLogotype} alt="Cunlink" />
          </div>
          ...
          <div class="sidebar-footer">
            <div class="sidebar-oddbit">
              ...
              <div class="copyright">
                &copy; {year} <a href="https://cunzhangblog.com" target="_blank" rel="noopener" style="color:inherit;text-decoration:none;">Web3村长</a>
              </div>
            </div>
          </div>
        </nav>
